...
const Categoria_model_1 = require("../Categoria/Categoria.model");
...
__decorate([
    graphql_1.Field(type => Categoria_model_1.Categoria),
    typeorm_1.ManyToOne(() => Categoria_model_1.Categoria, (categoria) => categoria.produtos),
...
__decorate([
    ...
    typeorm_1.OneToMany(type => ProdutoPedido_model_1.ProdutoPedido, produtoPedido => produtoPedido.produto),
